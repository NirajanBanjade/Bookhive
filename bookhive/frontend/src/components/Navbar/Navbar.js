          ...
          <div className="flex-1 max-w-2xl mx-8">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pl-10 pr-4 text-gray-700 bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
              />
              <svg
